...
class BattleTowerSearchV2SubAgentBattleTower(BattleTowerMaxDamageAgent):
...
def init_search_process(
    ...
    while True:
        ...
        try:
            agent = BattleTowerSearchV2SubAgentBattleTower(savestate_file, moves, swap_to=swap_to, stop_event=early_stop_event,
...
class BattleTowerSearchV3Agent(BattleTowerSearchV2Agent):
    """
    V3 Strategy:
    Basically the V2 strategy, except
    """
